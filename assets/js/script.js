const API_KEY = "_lxY6jtF2VUqz1tA5Cl4A9j920E"
...
function displayStatus(data) {
    ...
    contentHTML = `<div>Your key is valid until</div>
...
function displayErrors(data) {
    let heading = `JSHing Results for ${data.file}`;
